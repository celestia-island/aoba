...
/// Test slave writing to coils on master
...
pub async fn test_slave_write_coils() -> Result<()> {
    log::info!("🧪 Testing slave-to-master coil writes with virtual serial ports...");
    ...
    // 4. Master would update its coil values
    // 5. We would verify master's coil values changed
    //
    ...
    log::info!("✅ Slave-to-master coil write test completed");
    Ok(())
}
