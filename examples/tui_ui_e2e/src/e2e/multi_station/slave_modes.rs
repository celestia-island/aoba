//! Multi Station Slave Mode TUI UI E2E Test States
//!
//! This module provides state constructors for multi station slave mode tests,
...
pub fn create_tui_multi_slave_mixed_register_types_final_state() -> Status {
...
pub fn create_tui_multi_slave_spaced_addresses_final_state() -> Status {
    let mut status = create_multi_station_slave_base_state();
