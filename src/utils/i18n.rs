    ...
    pub Lang {
        ...
        protocol: {
            ...
            modbus: {
                ...
                data_source_port_forwarding: String = "data_source_port_forwarding".to_string(),
                data_source_source_port: String = "data_source_source_port".to_string(),
                ...
                data_source_placeholder_port_forwarding: String = "data_source_placeholder_port_forwarding".to_string(),
                data_source_port_forwarding_hint: String = "data_source_port_forwarding_hint".to_string(),
