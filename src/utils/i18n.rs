    ...
    pub Lang {
        ...
        protocol: {
            ...
            modbus: {
                ...
                data_source: String = "data_source".to_string(),
                data_source_port: String = "data_source_port".to_string(),
                data_source_path: String = "data_source_path".to_string(),
                data_source_address: String = "data_source_address".to_string(),
                data_source_manual: String = "data_source_manual".to_string(),
                data_source_transparent_forward: String = "data_source_transparent_forward".to_string(),
                data_source_mqtt: String = "data_source_mqtt".to_string(),
                data_source_http: String = "data_source_http".to_string(),
                data_source_ipc: String = "data_source_ipc".to_string(),
                data_source_python: String = "data_source_python".to_string(),
                data_source_placeholder_no_ports: String = "data_source_placeholder_no_ports".to_string(),
                data_source_placeholder_mqtt: String = "data_source_placeholder_mqtt".to_string(),
                data_source_placeholder_http: String = "data_source_placeholder_http".to_string(),
                data_source_placeholder_ipc_unix: String = "data_source_placeholder_ipc_unix".to_string(),
                data_source_placeholder_ipc_windows: String = "data_source_placeholder_ipc_windows".to_string(),
                data_source_placeholder_python_unix: String = "data_source_placeholder_python_unix".to_string(),
                data_source_placeholder_python_windows: String = "data_source_placeholder_python_windows".to_string(),
                err_invalid_url: String = "err_invalid_url".to_string(),
                err_file_not_found: String = "err_file_not_found".to_string(),
            },
            mqtt: {
